...
//
//			ret = new String(c.doFinal(byteStr), "UTF-8");
//
//		} catch (InvalidAlgorithmParameterException e) {
//			log.error(e.getMessage(), e);
//		} catch (IndexOutOfBoundsException e) {
...
//
//	//단방향 salt 생성
//	//생성할 saltString의 길이의 절반인 숫자를 파라메터로 받음.
//	//param - int
//	//return - string
//	public String makeHashSalt(int length) {
//
...
//			}
//
//			saltString = new String(salt.toString().getBytes(), "UTF-8");
//
//		} catch (IndexOutOfBoundsException e) {
//			log.error(e.getMessage(), e);
//		} catch (IllegalArgumentException e) {
...
////	1회성 hash를 할때 사용
//	public String makeHash(byte[] bytes, String cryptoType) {
//
//		String ret = null;
//
//		try {
//			// Create crypto_type Hash
//			MessageDigest digest = java.security.MessageDigest.getInstance(cryptoType);
//			digest.update(bytes);
...
//	}
//
//	public  String AriaDecrypt(String input) {
//
//		CreateMasterKey(secretKey);
//		int[] rk = new int[16 * 17];
//		int[] c = new int[16];
